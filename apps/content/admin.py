...
class NewsItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Link", {
            "fields": ("source_url",),
            "description": "Optional link to the original source or related page.",
        }),
        ("Publication", {
            "fields": ("is_published", "published_at"),
        }),
        ("System", {
            "fields": ("source_type", "source_id", "created_at", "updated_at"),
            "classes": ("collapse",),
        }),
    )
    ...
    def save_model(self, request, obj, form, change):
        ...
        obj.source_type = NewsItem.SourceType.MANUAL
        obj.source_id = None
